 ...
 *
 * Last modified: 2020.07.08 at 13:12
 */

declare(strict_types=1);


namespace Neunerlei\ConfigExample\Plugins\plugin3\ContentElement;
...
class TextContentElement extends AbstractContentElementConfiguration
{
    ...
    {
        $configurator->setTitle('Text Element');
        $configurator->setOption('foo', 'bar');
        $configurator->setOption('bar', 'baz');
    }
