 ...
 *
 * Last modified: 2020.07.08 at 13:25
 */

declare(strict_types=1);


namespace Neunerlei\ConfigExample\Project\ContentElement;
...
class ImageContentElement extends AbstractContentElementConfiguration
{
    /**
     * @inheritDoc
     */
    ...
    {
        $configurator->setTitle('Image element');
        $configurator->setOption('type', 'image');
    }
