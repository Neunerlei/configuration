 ...
 *
 * Last modified: 2020.07.08 at 11:27
 */

declare(strict_types=1);


namespace Neunerlei\ConfigExample\Project\Config;
...
class PluginConfig implements ExampleConfigurePluginInterface
{
    ...
    {
        $configurator->setOption('projectOption');
        $configurator->addToList('projectValue');
    }
