 ...
 *
 * Last modified: 2020.07.14 at 15:45
 */

declare(strict_types=1);


namespace Neunerlei\ConfigTests\Fixture\ModifierTest\General\Config;
...
class FixtureTestModifierConfig2 implements FixtureTestModifierInterface,
                                            FixtureTestConfigInterface,
                                            ModifyConfigOrderInterface
{
    ...
    {
        $executeMeAfter[] = FixtureTestModifierConfig4::class;
    }
